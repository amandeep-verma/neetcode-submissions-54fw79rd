class Solution:
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
        ...
        """Solution 2 - exactly same as 1, but instead of list to sort, using dictionary itself 
        n(log(n)) """
        ...
        # # Insertion of n item will take n log(n) time, We will make it better in Solution 4
        ...
        """Solution 4 - using prirotyQueue with heapify"""
        ...
        # # Still adding all elements to heap, can be avoided - Sol 5
        ...
        """Solution 5 - using prirotyQueue but limiting the size of heap by k"""
